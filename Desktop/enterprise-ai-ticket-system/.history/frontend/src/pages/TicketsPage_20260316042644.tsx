      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-lg bg-[var(--primary)] px-3 py-2 text-sm text-[var(--primary-text)] hover:brightness-110 shadow-[0_10px_30px_-18px_color-mix(in_oklab,var(--primary)_55%,transparent)]"
          >
            + Yeni Ticket
          </button>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="w-full max-w-xl rounded-2xl border border-[var(--stroke)] bg-[var(--card2)] shadow-[0_30px_90px_-40px_rgba(0,0,0,0.9)] backdrop-blur">
            ...
            <form onSubmit={onCreate} className="grid gap-3 p-4">
              <input
                className="rounded-lg border border-[var(--stroke)] bg-white/5 px-3 py-2 text-[var(--text)] outline-none placeholder:text-white/40 focus:ring-2 focus:ring-[var(--primary)]"
                value={title}
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="rounded-lg bg-[var(--primary)] px-4 py-2 text-sm text-[var(--primary-text)] hover:brightness-110 disabled:opacity-60"
                >
  ...
  return (
    <button
      ...
      className={[
        ...
        active
          ? "border-white/10 bg-[var(--primary)] text-[var(--primary-text)] shadow-[0_10px_30px_-18px_color-mix(in_oklab,var(--primary)_55%,transparent)]"
