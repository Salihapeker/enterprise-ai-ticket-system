    ...
    <div className="min-h-screen text-[var(--text)]">
      <div className="w-full p-4">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[260px_1fr]">
          <aside className="rounded-2xl border border-[var(--stroke)] bg-[var(--card)] p-4 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.6)] backdrop-blur">
          ...
          <main className="rounded-2xl border border-slate-200/70 bg-[var(--card)] shadow-sm">
